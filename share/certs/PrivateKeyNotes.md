...
unlocked to sign the Datacoin-Qt.app bundle.
...
allowing somebody to distribute a Datacoin-Qt.app or datacoin-qt-setup.exe with a valid
...
that the datacoin-qt.exe file inside the installer had not been tampered with.
