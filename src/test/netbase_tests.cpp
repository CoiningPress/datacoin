...
{
    BOOST_CHECK(TestSplitHost("www.datacoininfo.org", "www.datacoininfo.org", -1));
    BOOST_CHECK(TestSplitHost("[www.datacoininfo.org]", "www.datacoininfo.org", -1));
    BOOST_CHECK(TestSplitHost("www.datacoininfo.org:80", "www.datacoininfo.org", 80));
    BOOST_CHECK(TestSplitHost("[www.datacoininfo.org]:80", "www.datacoininfo.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4777", "127.0.0.1", 4777));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4777", "127.0.0.1", 4777));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4777", "::ffff:127.0.0.1", 4777));
    BOOST_CHECK(TestSplitHost("[::]:4777", "::", 4777));
    BOOST_CHECK(TestSplitHost("::4777", "::4777", -1));
    BOOST_CHECK(TestSplitHost(":4777", "", 4777));
    BOOST_CHECK(TestSplitHost("[]:4777", "", 4777));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4777", "127.0.0.1:4777"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4777", "[::]:4777"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
