...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 2039469, uint256("0xab93d02fa037af32794ab8f5ceff487a220e8d8beb38fd2dcf7222205eeccd43"))
        ;
    static const CCheckpointData data = {
        &mapCheckpoints,
        1505899679, // * UNIX timestamp of last checkpoint block
        2330376,    // * total number of transactions between genesis and last checkpoint
