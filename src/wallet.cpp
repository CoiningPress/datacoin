...
void CWalletTx::RelayWalletTransaction()
{
    ...
    {
        // Important: versions of datacoin before 0.8.6 had a bug that inserted
                                ...
                                const std::string& txData)
{
    ...
    if (txData.size() > MAX_TX_DATA_SIZE) {
        strFailReason = _("txData is too large");
        return false;
    }
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            loop
            {
                ...
                if (nChange > 0)
                {
                    ...
                    // change transaction isn't always pay-to-datacoin-address
