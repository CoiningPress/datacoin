...
In order to support loading of multiple wallets in datacoin-qt, a few changes in the UI architecture will be needed.
...
Finally, three new headers and source files will have to be added to datacoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into datacoin-qt, and as such, will require some minor modifications to provide hooks for
