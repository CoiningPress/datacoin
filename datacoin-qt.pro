...
contains(DATACOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += DATACOIN_NEED_QT_PLUGINS
...
contains(DATACOIN_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = datacoin-qt_test
DEFINES += DATACOIN_QT_TEST
...
# also add new translations to src/qt/datacoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/datacoin_*.ts)
...
win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/datacoin-qt.rc
...
macx:ICON = src/qt/res/icons/datacoin.icns
